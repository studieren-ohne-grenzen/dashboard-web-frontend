...
frequency_lists = require('./frequencyLists');
...
GRAPHS = {
  ...
  qwertzAltgr: adjacency_graphs.qwertzAltgr,
...
matching = {
  ...
  spatial_match_helper: function(password, graph, graph_name) {
    ...
    while (i < password.length - 1) {
      ...
      last_direction = null;
      turns = 0;
      if ((graph_name === 'qwerty' || graph_name === 'dvorak' || graph_name === 'qwertz' || graph_name === 'qwertzAltgr') && this.SHIFTED_RX.exec(password.charAt(i))) {
        shifted_count = 1;
      } else {
        shifted_count = 0;
      }
